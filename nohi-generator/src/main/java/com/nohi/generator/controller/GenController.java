package com.nohi.generator.controller;
...
import com.nohi.generator.service.IGenTableColumnService;
import com.nohi.generator.service.IGenTableService;
...
public class GenController extends BaseController {
    ...
    @GetMapping("/list")
    public R<TableDataInfo> genList(GenTable genTable) {
        startPage();
    ...
    @PreAuthorize("@ss.hasPermi('tool:gen:list')")
    @GetMapping("/db/list")
    public R<TableDataInfo> dataList(GenTable genTable) {
        startPage();
    ...
    public R<TableDataInfo> columnList(Long tableId) {
